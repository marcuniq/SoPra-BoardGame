...
public class GameArrayAdapter extends GenericArrayAdapter<GameBean> {
    ...
    public GameArrayAdapter(Context context,  int resource, int textResourceId, int imageResourceId, ArrayList<GameBean> game) {
     ...
     */
    @Override
    public void drawText(TextView textView, GameBean game) {
