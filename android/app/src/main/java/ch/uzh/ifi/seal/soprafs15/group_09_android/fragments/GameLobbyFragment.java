...
public class GameLobbyFragment extends ListFragment {
    ...
    private void startGame(){
        UserBean user = UserBean.setToken(token);
        RestService.getInstance(getActivity()).start(gameId, user, new Callback<GameBean>() {
            @Override
    ...
    private void startGameInFastMode(){
        UserBean user = UserBean.setToken(token);
        RestService.getInstance(getActivity()).startFastMode(gameId, user, new Callback<GameBean>() {
            @Override
            public void success(GameBean game, Response response) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
